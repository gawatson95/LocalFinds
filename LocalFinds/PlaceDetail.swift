...
struct PlaceDetail: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case location, description, name, photos, popularity, rating, tel, verified, website
    }
}

struct Hours: Codable {
    let display: String
    let isLocalHoliday, openNow: Bool
...
struct Location: Codable {
    let address, censusBlock, country, crossStreet: String
